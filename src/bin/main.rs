...
fn run (args: Args) -> error::Result<()> {
    ...
    // 5d	pop    %rbp
    // c3	retq
    //obj.add_code("_main", vec![0x55, 0x48, 0x89, 0xe5, 0xb8, 0x00, 0x00, 0x00, 0x00, 0xe8, 0x00, 0xff, 0xff, 0xff, 0x89, 0xc6, 0x48, 0x8d, 0x3d, 0x00, 0x00, 0x00, 0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0xe8, 0x00, 0x00, 0x00, 0x00, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x5d, 0xc3]);
    obj.add_code("main",
        vec![0x55,
             0x48, 0x89, 0xe5,
